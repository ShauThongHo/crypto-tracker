...
<section id="view-portfolio" class="content-view block p-4 md:p-8 lg:p-12">
        ...
        <div>
            ...
            <div class="flex items-baseline gap-4">
                ...
                <div class="flex items-center gap-2 px-2 py-1 bg-green-500/10 rounded-full border border-green-500/20">
                    ...
                    <span id="sync-badge" class="text-[10px] text-green-500 font-bold uppercase tracking-tighter">Sync Aligned</span>
                </div>
            </div>
        </div>
    ...
    <div class="w-full h-64 md:h-80 bg-[#0f172a] border border-slate-800 rounded-3xl mb-8 p-4 relative">
        <div class="absolute top-6 right-8 z-20 flex gap-2">
            <button onclick="changeRange('1D')" class="range-btn bg-sky-500 text-white text-[10px] font-bold px-3 py-1 rounded-md">1D</button>
            <button onclick="changeRange('7D')" class="range-btn bg-slate-800 text-slate-400 text-[10px] font-bold px-3 py-1 rounded-md">7D</button>
            <button onclick="changeRange('30D')" class="range-btn bg-slate-800 text-slate-400 text-[10px] font-bold px-3 py-1 rounded-md">30D</button>
        </div>
